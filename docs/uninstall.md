...
You can just run this Uninstall application from the DMG package, or you can save it in your Applications Folder if you want to keep it for later (although you can also just re-download the DMG later down the line too).
