...
You can download the latest **CommandPost v1.4.21** release [here](https://github.com/CommandPost/CommandPost/releases/download/1.4.21/CommandPost_1.4.21.dmg){target="_blank"}.
