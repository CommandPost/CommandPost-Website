...
You can download the latest **CommandPost v1.4.24** release [here](https://github.com/CommandPost/CommandPost/releases/download/1.4.24/CommandPost_1.4.24.dmg){target="_blank"}.
