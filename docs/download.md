...
You can download the latest **CommandPost v1.4.27** release [here](https://github.com/CommandPost/CommandPost/releases/download/1.4.27/CommandPost_1.4.27.dmg){target="_blank"}.
