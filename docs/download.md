...
You can download the latest **CommandPost v1.4.26** release [here](https://github.com/CommandPost/CommandPost/releases/download/1.4.26/CommandPost_1.4.26.dmg){target="_blank"}.
