...
You can download the latest **CommandPost v1.4.23** release [here](https://github.com/CommandPost/CommandPost/releases/download/1.4.23/CommandPost_1.4.23.dmg){target="_blank"}.
