...
const directoryPath = path.join(process.env.GITHUB_WORKSPACE, 'docs/_includes/snippets');
const outputFile = path.join(process.env.GITHUB_WORKSPACE, 'docs/_includes/generated-snippets.md');
...
try {
    fs.readdir(directoryPath, function (err, files) {
        ...
        files.forEach(function (file) {
            ...
            fileContent += `{{ include "snippets/${fileNameWithoutExtension}" }}\n\n---\n\n`;
        });
